...
$route['cron-proof'] = 'front/cron_proof';
$route['draw'] = 'front/draw';
// $route['gpcastellet'] = 'front/draw';
$route['poolposition'] = 'front/draw';
$route['gpitalie'] = 'front/draw';
...
$route['thankyou_robot'] = 'front/thankyou_op1';
$route['thankyou_draw'] = 'front/thankyou_op2';
$route['thankyou_op3'] = 'front/thankyou_op3';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['send_mail'] = 'front/sendMail';