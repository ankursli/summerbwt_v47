...
$config['base_url'] = 'http://localhost:8888/summerbwt_v31/';
...
$config['email']['smtp_host'] = 'mail.smtp2go.com';
// $config['smtp_port'] = '2525'; // 8025, 587 and 25 can also be used. Use Port 465 for SSL.
$config['email']['smtp_port'] = '587'; // 8025, 587 and 25 can also be used. Use Port 465 for SSL.
$config['email']['smtp_crypto'] = 'tls';
$config['email']['smtp_user'] = 'bwt22';
$config['email']['smtp_pass'] = 'UPWKng3ZrMtql5tB';
