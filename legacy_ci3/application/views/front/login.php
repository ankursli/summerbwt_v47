	...
	<div class="login-box-body">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<h4 class="login-box-msg" style="text-align: center;" ><?php echo lang('label_login');?></h4>
		...
		<form action="<?php echo base_url('front/checkLogin');?>" method="post">
			...
			<div class="row" >
				...
				<div class="col-sm-6" style="margin:0 auto;" >
					...
					<div class="form-group has-feedback">
						...
						<input type="text" class="form-control" name="email" placeholder="<?php echo $this->lang->line('label_email_or_username');?>">
			...
			<div class="row">
				...
				<div class="col-sm-6" style="margin:0 auto;" >
					...
					<button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo $this->lang->line('label_login_btn');?></button>
		...
		<div class="row" >
			...
			<div class="col-sm-6" style="margin:0 auto;" >
				...
				<a href="<?php echo base_url('forgotpassword');?>" style="float: left;"  ><?php echo $this->lang->line('label_reset_password');?></a>

				<a href="<?php echo base_url('register');?>" style="float: right;" ><?php echo $this->lang->line('label_create_an_account');?></a>
