			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6">
					...
					<div class="inner-header">
						...
						<h3><?php echo $this->lang->line('label_robot_offer_reduction'); ?></h3>

						<h2><?php echo $this->lang->line('label_robot_offer_inner'); ?></h2>
				...
				<div class="col-sm-12 col-md-6 offer-left-section">
					<div class="offer-content-inner clearfix">
						...
						<div class="date-box">
							...
							<p><?php echo $this->lang->line('label_from_may_july_inline'); ?> </p>

						</div>

						<div class="offer-text m-font-40">

							<h1><?php echo $this->lang->line('label_up_to_discountp'); ?></h1>
						...
						<div class="price-odr">
							...
							<p><?php echo $this->lang->line('label_Pour_lachat_dun_robot'); ?>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p600'); ?> :
								<span class="m-font-30"><?php echo $this->lang->line('label_150_€_discount'); ?></span>
							</p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p500'); ?> :
								<span class="m-font-30"><?php echo $this->lang->line('label_100_€_discount'); ?></span>
							</p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p400'); ?> :
								<span class="m-font-30"><?php echo $this->lang->line('label_50_€_discount'); ?></span>
							</p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_250_cosmy'); ?> :
								<span class="m-font-30"><?php echo $this->lang->line('label_60_€_discount'); ?></span>
							</p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_200_cosmy'); ?> :
								<span class="m-font-30"><?php echo $this->lang->line('label_50_€_discount'); ?></span>
							</p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_150_cosmy'); ?> :
								<span class="m-font-30"><?php echo $this->lang->line('label_40_€_discount'); ?></span>
							</p>

							<!--	<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_100_cosmy'); ?> : 
							<span class="m-font-30"><?php echo $this->lang->line('label_30_€_discount'); ?></span></p> -->
						...
						<div class="btn-condition">
							<?php if (!empty($_SESSION['site_lang'])) {
								if ($_SESSION['site_lang'] == 'english') { ?>
									<a target="_blank" href="<?php echo base_url(); ?>assets/legal/BWT-Offre-Robots-EN.pdf" class="btn  btn-block" style="color:#F5B5CA;background-color:#fff;border-color: #fff;"><?php echo $this->lang->line('label_reglementlink_data'); ?></a>

								<?php	} else {  ?>
									<a target="_blank" href="<?php echo base_url(); ?>assets/legal/BWT-Offre-Robots-FR.pdf" class="btn btn-primary btn-block"><?php echo $this->lang->line('check_btn'); ?></a>
					...
					<div class="offer-form-inner mobilebgcoloproofdiv clearfix">
						<div class="form-title">
							...
							<h2><?php echo $this->lang->line('label_to_get_your_robot'); ?> :</h2>

						</div>
						<div class="form-main">
							<form class="form-in" role="form" method="post" action="<?php echo ('/front/create_proof_of_purchase_new'); ?>" enctype="multipart/form-data">
								<div class="row">
								...
								<div class="form-group">
									<label for="inputGroupFile01"><?php echo $this->lang->line('label_download'); ?> <span>
											<?php echo $this->lang->line('label_your_proof_of_purchase'); ?></span></label>
								...
								<div class="form-group field-second">
									...
									<div class="error"><?php echo form_error('robot_id'); ?></div>
								...
								<select name="store_country" class="custom-select store_country" id="selectrobotcountry">
									...
									?>
										<option value="<?php echo $getcountry['country_code']; ?>"  <?php if ($getcountry['country_code'] == $store_country) {
																										echo 'selected';
																									} ?>      ><?php echo $this->lang->line('ntname'); ?></option>
										<?php
										} else {
										?>
										<option value="<?php echo $getcountry['country_code']; ?>" <?php if ($getcountry['country_code'] == $store_country) {
																										echo 'selected';
																									} ?> ><?php echo $getcountry['country_name']; ?></option>
										<?php
										}
									} ?>
								</select> -->
									...
									<select name="store_id" class="custom-select store_id" id="selectpurchase">
										...
										<option value="AUTRE" handle="autre" <?php if ('AUTRE' == $store_id) {
																					echo 'selected';
																				} ?>><?php echo $this->lang->line('autre'); ?></option>
									</select>
								...
								<div class="form-group field-ibanno bankdetails">
									...
									<div class="error"><?php echo form_error('bank_iban'); ?></div>
								</div>
