					...
					<div class="first-block single-block" >
						...
						<a href="<?php echo $bloc['link'];?>">
							...
							<div class="block-wrap-button text-center">
								<a href="<?php echo $bloc['link'];?>" class="block-button btn"><?php echo $this->lang->line('label_take_advantage');?></a>
							</div>
						</a>
						</div>
					</div>
				...
				<div class="col-sm-12 <?php echo $blockoffset2; ?> col-lg-4 col-md-6 bloc2">
					<div class="second-block single-block">
						...
						<a href="<?php echo $bloc['link'];?>">
							...
							<div class="block-wrap-button text-center">
								<a href="<?php echo $bloc['link'];?>" class="block-button btn"><?php echo $this->lang->line('label_try_your_luck');?></a>
							</div>
						</a>
						</div>
					</div>	
				...
				<div class="col-sm-12 <?php echo $blockoffset3; ?> col-lg-4 col-md-6 col33 bloc3">
					...
					<div class="third-block single-block">
						...
						<a href="<?php echo $bloc['link'];?>">
							...
							<div class="block-wrap-button text-center">
								<a href="<?php echo $bloc['link'];?>" class="block-button btn"><?php echo $this->lang->line('label_read_more');?></a>
							</div>
						</a>	
						</div>
					</div>
