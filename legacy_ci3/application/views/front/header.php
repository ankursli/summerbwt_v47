...
<body class="<?php echo $this->router->fetch_method(); ?> <?php if(!empty($_SESSION['site_lang'])){
    ...
    <div class="waiting-wrapper" style="display:none">
		<div class="row">
			...
			<div class="col-md-12 text-center logomobile">
				<h2 class="home-text"><?php echo $this->lang->line('home_header_text'); ?></h2>
			</div>
    ...
    <div class="wrapper">
		<header class="header-area a" id="header-area">
					...
					<div class="row">
						...
						<nav class="dope-navbar justify-content-between" id="dopeNav">
							...
							<div class="col-md-4 hiddenmobile">
								<img class="summerlogo" src="<?php echo base_url();?>assets/image/summer_logo.png" alt="">
							</div>
								...
								<div class="dopenav">
									<ul id="nav">
										<!-- <li class="<?php echo ($lastparam=='') ? 'active':'';?>">
											<a href="<?php echo base_url();?>"><?php echo $this->lang->line('label_home'); ?></a>
										</li> -->
...
<!-- REMOVE MENU contrat d'excellence>		<li class="<?php echo ($lastparam=='contrat-dexcellence') ? 'active':'';?> menu1">
											...
											if(!empty($_SESSION['site_lang'])){
												...
												if($_SESSION['site_lang']=='netherland'){
													echo $this->lang->line('label_refund');
												}
												if($_SESSION['site_lang']=='french'){
						...
						FIN		-->
										...
										<!-- <li class="<?php echo ($lastparam=='modifier-mon-profil') ? 'active':'';?>">
											...
											if(!empty($_SESSION['site_lang'])){
												if($_SESSION['site_lang']=='english'){
													echo $this->lang->line('label_edit_profile');
												}
												if($_SESSION['site_lang']=='french'){
										...
										<li class="<?php echo ($lastparam=='login') ? 'active':'';?>">
											<a href="<?php echo base_url('login');?>" class="active"><?php echo $this->lang->line('label_login_btn'); ?></a>
										</li>
										<?php }else{ ?>
										<li class="<?php echo ($lastparam=='logout') ? 'active':'';?>">
											<a href="<?php echo base_url('logout');?>"><?php echo $this->lang->line('label_logout'); ?></a>
										</li>
