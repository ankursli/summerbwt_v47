<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('label_edit_draw');?>
      </h1>
	  <ol class="breadcrumb">
		...
		<li class="active"><?php echo $this->lang->line('label_edit_draw');?></li>
      </ol>
    </section>
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url('admin/draw/finalupdate?draw='.$draws[0]['draw_id']);?>" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="form-group">
						<label><?php echo $this->lang->line('label_store');?> :</label>
					...
					<a class="btn btn-danger" data-toggle="modal" data-target="#rejectmodal-<?php echo $draws[0]['draw_id'];?>"><?php echo $this->lang->line('label_rejected');?></a>
					<?php } ?>
				</div>
			</form>
			<!-- Modal -->
						...
						<tbody>
							...
							<tr style="background-color:<?php echo $color;?>">
								...
								<td> 
									...
									<a href="<?php echo base_url('admin/draw/update?purchase='.$draws[0]['draw_id'].'&status=1&coupon='.$couponcode['coupon_code']);?>" class="btn btn-primary"><?php echo $this->lang->line('label_approved');?></a>
