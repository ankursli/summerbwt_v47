<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('label_view_refund');?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('admin/dashboard');?>"><i class="fa fa-dashboard"></i><?php echo $this->lang->line('label_home');?></a></li>
        <li><a href="<?php echo base_url('admin/refund');?>"><?php echo $this->lang->line('label_refund');?></a></li>
        <li class="active"><?php echo $this->lang->line('label_view_refund');?></li>
      </ol>
    </section>
              ...
              <table id="viewuser" class="table table-bordered table-striped">
                <thead>
					<tr>
						...
						<th><?php echo $this->lang->line('label_modal');?></th>
						
						<th>Roboto Infomation<?php //echo $this->lang->line('label_store_of_purchase');?></th>
						<th><?php echo $this->lang->line('label_stores');?></th>
						<th><?php echo $this->lang->line('label_date_of_purchase');?></th>
						<th><?php echo $this->lang->line('label_upload_proof');?></th>
						<th><?php echo $this->lang->line('label_messages');?></th>
                ...
                <tbody>
					...
					if($refund['store_id']!=0){
					
						$anothergetstores = $this->Mdl_Store->GetRecordUsers(array('id'=>$refund['store_id']));
					...
					<tr>
						...
						<td>  
							<a href="<?php echo base_url('admin/Refund/remove/'.$refund['refund_id']);?>" class="btn btn-danger"><?php echo $this->lang->line('label_remove');?></a>
						</td>
					</tr>
					<?php } ?>
                </tbody>
					<tfoot>
						...
						<th>Roboto Infomation<?php //echo $this->lang->line('label_store_of_purchase');?></th>
						<th><?php echo $this->lang->line('label_stores');?></th>
							<!--th><?php echo $this->lang->line('label_store_of_purchase');?></th-->
							<th><?php echo $this->lang->line('label_upload_proof');?></th>
							<th><?php echo $this->lang->line('label_messages');?></th>
							<th><?php echo $this->lang->line('label_bank_details');?></th>
							<th>client Type</th>
