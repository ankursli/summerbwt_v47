<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content-header">
	  ...
	  <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('admin/storerobot/Viewstore');?>"><?php echo $this->lang->line('label_stores');?></a></li>
            ...
            <form role="form" method="post" action="<?php echo base_url('admin/storerobot/create');?>" enctype="multipart/form-data">
				...
				<div class="box-body">
					...
					<div class="form-group">
					  ...
					  <label for="exampleInputFName"><?php echo $this->lang->line('label_store_email');?></label>
					...
					<div class="form-group">
					  ...
					  <label for="exampleInputFName"><?php echo $this->lang->line('label_store_phone');?></label>
