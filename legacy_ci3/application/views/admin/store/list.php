                ...
                <tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo base_url('admin/store/edit/'.$store['id']);?>" class="btn btn-primary"><?php echo $this->lang->line('label_edit');?></a>  

							<a href="<?php echo base_url('admin/store/remove/'.$store['id']);?>" class="btn btn-danger"><?php echo $this->lang->line('label_remove');?></a>
