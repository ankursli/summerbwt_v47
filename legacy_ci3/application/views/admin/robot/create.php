            ...
            <form role="form" method="post" action="<?php echo base_url('admin/robot/create');?>" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" name="robot_name" placeholder="<?php echo $this->lang->line('label_enter_robot_name');?>" value="<?php echo (isset($_POST['robot_name'])) ? $_POST['robot_name']:'';?>">
					...
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" name="robot_code" placeholder="<?php echo $this->lang->line('label_enter_robot_code');?>" value="<?php echo (isset($_POST['robot_code'])) ? $_POST['robot_code']:'';?>">
					...
					<div class="form-group">
					  ...
					  <input type="number" class="form-control" name="robot_price" placeholder="<?php echo $this->lang->line('label_enter_robot_price');?>" value="<?php echo (isset($_POST['robot_price'])) ? $_POST['robot_price']:'';?>">
