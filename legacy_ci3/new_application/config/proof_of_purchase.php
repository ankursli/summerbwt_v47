							...
							<div class="form-group">
							   <label for="inputGroupFile01"><?php echo $this->lang->line('label_download'); ?> <span>
								...
								<div class="custom-file">
									...
									<?php if($upload_proof!='') { ?>
									<span class="pip"><img class="imageThumb" src="<?php echo base_url('upload').'/offer_roboto/'. $upload_proof; ?>" title="<?php echo $upload_proof; ?>"><br><span class="remove">supprimer l'image</span></span>
									<?php } ?>
									
									<label class="custom-file-label" for="inputGroupFile01"></label>
								</div>
								 <input type="hidden" value="<?php echo $upload_proof; ?>" id="uplodehidenfile">
