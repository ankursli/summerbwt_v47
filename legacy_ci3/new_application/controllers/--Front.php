...
require '/var/www/clients/client0/web11/web/phpmailer/Exception.php';
require '/var/www/clients/client0/web11/web/phpmailer/PHPMailer.php';
require '/var/www/clients/client0/web11/web/phpmailer/SMTP.php';
		...
		if(!empty($_SESSION['front_user'])){
			...
			if($ispost=='POST'){
				...
				//$response = $mj->post(Resources::$Email, ['body' => $body]);
						...
						$list = array('marc@webstorm.fr,summerbwt@facility.fr');
						$this->email->cc($list);
						$this->email->subject($template_subject);
