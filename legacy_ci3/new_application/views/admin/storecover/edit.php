      ...
      <div class="row">
		...
		<div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url('admin/storeCover/update/'.$stores[0]['id']);?>" enctype="multipart/form-data">
				...
				<div class="box-body">
					...
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" name="store_code" placeholder="<?php echo $this->lang->line('label_enter_store_code');?>" value="<?php echo $stores[0]['store_code'];?>">
