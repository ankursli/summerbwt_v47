...
<section class="content-header">
  ...
  <h1>
	...
	<?php echo $this->lang->line('label_view_store');?>
  ...
  <ol class="breadcrumb">
	...
	<li><a href="<?php echo base_url('admin/storeCover/Viewstore');?>"><?php echo $this->lang->line('label_cover_stores');?></a></li>

	<li class="active"><?php echo $this->lang->line('label_view_store');?></li>
	  ...
	  <div class="box">
		...
		<div class="box-header">
			...
			<div class="showuserfile" style="display:none">
				...
				<?php echo form_open_multipart('admin/storeCover/UploadImportFile');?>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="<?php echo base_url('admin/storeCover/edit/'.$store['id']);?>" class="btn btn-primary"><?php echo $this->lang->line('label_edit');?></a>  

						<a href="<?php echo base_url('admin/storeCover/remove/'.$store['id']);?>" class="btn btn-danger"><?php echo $this->lang->line('label_remove');?></a>
