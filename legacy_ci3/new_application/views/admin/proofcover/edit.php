      ...
      <div class="row">
		<div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo base_url('admin/proofCover/finalupdate?purchase='.$proofs[0]['purchase_id']);?>" enctype="multipart/form-data">
				<div class="box-body">
					<?php 
					...
					<div class="form-group">
						...
						<a class="image-popup-fit-width" href="<?php echo base_url('upload').'/op3/'.$proofs[0]['upload_proof'];?>">
							<img src="<?php echo base_url('upload').'/op3/'.$proofs[0]['upload_proof'];?>" alt="<?php echo $proofs[0]['upload_proof'];?>" width="75" height="75"/>
						</a>
					</div>
					<!--div class="form-group">
					...
					<div class="form-group">
						<label><?php echo $this->lang->line('label_cover');?> :</label>
						<span><?php echo $proofs[0]['cover_name'];?></span>
					</div>
					<div class="form-group">
					...
					if($proofs[0]['another_store_handle']!=0){
						$anothergetstores = $this->Mdl_Store->GetRecordUsers(array('id'=>$proofs[0]['another_store_handle']));
