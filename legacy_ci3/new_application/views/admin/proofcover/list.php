<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('label_view_proof_of_cover_purchase');?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('admin/dashboard');?>"><i class="fa fa-dashboard"></i><?php echo $this->lang->line('label_home');?></a></li>
        <li><a href="<?php echo base_url('admin/proofCover');?>"><?php echo $this->lang->line('label_proof_of_cover_purchase');?></a></li>
        <li class="active"><?php echo $this->lang->line('label_view_proof_of_cover_purchase');?></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
				<a class="btn btn-primary" style="float:right;" href="<?php echo base_url('admin/proofCover/export_proof');?>">Export Robot</a>
            </div>
            <!-- /.box-header -->
			<div class="box-body">
				<?php 
             ...
             <table id="viewuser" class="table table-bordered table-striped">
                <thead>
					<tr>
						...
						<th><?php echo $this->lang->line('label_cover');?></th>
						<th>Cover Infomation</th>
                ...
                <tbody>
					...
					foreach($proofs as $proof){
						...
						$coupon = $this->Mdl_Cover->GetRecordUsers(array('id'=>$proof['coupon_id']));
					?>
					<tr>
						<td><?php echo $proof['purchase_id'];?></td>
						<td><?php echo $proof['email'];?></td>
						<td><?php echo $coupon[0]['cover_name'];?></td>
						<td><b>Serial no :</b><?php echo $proof['robot_serial_no'];?> <br/><b>Cover Date:</b><?php echo $proof['coupon_list_code'];?> <br/></td>
						...
						<td><?php echo $proof['coupon_list_code'];?></td>
						...
						<td>
							...
							<a href="<?php echo base_url('admin/proofCover/edit/'.$proof['purchase_id']);?>" class="btn btn-primary"><?php echo $this->lang->line('label_edit');?></a>  
							<?php //} ?>
							<a href="<?php echo base_url('admin/proofCover/remove/'.$proof['purchase_id']);?>" class="btn btn-danger"><?php echo $this->lang->line('label_remove');?></a>
						</td>
					</tr>
					<?php } ?>
                </tbody>
