<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('label_view_coupon_code');?>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo $this->lang->line('label_view_coupon_code');?></li>
      </ol>
    </section>
              ...
              <table id="viewuser" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr style="background-color:<?php echo $color;?>">
						...
						<td> 
							<a href="<?php echo base_url('admin/storecoupon/remove_coupon/'.$couponcode['coupon_list_id']);?>" class="btn btn-danger"><?php echo $this->lang->line('label_remove');?></a>
						</td>
					</tr>
					<?php } ?>
                </tbody>
