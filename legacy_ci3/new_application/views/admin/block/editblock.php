				...
				<div class="form-group">
					<div class="row" >
						...
						<div class="col-sm-4">
							...
							<input type="number" name="opacity" class="form-control" min="0" max="1" step="0.01" value="<?php echo $block[0]['opacity'];?>" />
					...
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<input type="text" name="link" class="form-control" value="<?php echo $block[0]['link'];?>" />
