				...
				<div class="col-sm-12 col-md-6 offer-left-section">
					...
					<div class="offer-content-inner clearfix">
						...
						<div class="price-odr">
							...
							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p600_robot'); ?> : <br/>
							<span class="m-font-30"><?php echo $this->lang->line('label_100_€_discount'); ?></span>
						   </p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p500_robot'); ?> : <br/>
							<span class="m-font-30"><?php echo $this->lang->line('label_50_€_discount'); ?></span></p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p400_robot'); ?> : <br/><span class="m-font-30"><?php echo $this->lang->line('label_30_€_discount'); ?></span></p>
