...
<div class="offer-content-inner clearfix">
	...
	<?php 	if(!empty($_SESSION['site_lang'])){
				...
				<a target="_blank" href="<?php echo base_url();?>assets/legal/BWT-Reglement-jeu-chimie-EN.pdf" class="btn  btn-block" style="color:#e5006b;background-color:#fff;border-color: #fff;"><?php echo $this->lang->line('button_regl_jeu_page_draw');?></a>

			<?php	} else {  ?>
				<a target="_blank" href="<?php echo base_url();?>assets/legal/BWT-Reglement-jeu-chimie-FR.pdf" class="btn  btn-block" style="color:#e5006b;background-color:#fff;border-color: #fff;"><?php echo $this->lang->line('button_regl_jeu_page_draw');?></a>
