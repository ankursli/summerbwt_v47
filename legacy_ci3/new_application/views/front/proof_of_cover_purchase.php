<section class="offer-cover-section1 inner-page">
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6">
					...
					<div class="inner-header">
						...
						<h3><?php echo $this->lang->line('label_cover_offer_reduction'); ?></h3>

						<h2><?php echo $this->lang->line('label_cover_offer_inner'); ?></h2>
...
<section class="offer-cover-section2">
				...
				<div class="col-sm-12 col-md-6 offer-left-section">
					...
					<div class="offer-content-inner clearfix">
						...
						<div class="date-box">
							...
							<p><?php echo $this->lang->line('label_from_jan_march_inline'); ?> </p>

						</div>

						<div class="offer-text m-font-40">

							<h1><?php echo $this->lang->line('label_up_to_cover_discountp'); ?></h1>

						</div>

						<div class="more-text">

							<p><?php echo $this->lang->line('label_valid_on_page_robot'); ?> </p>

						</div>

						<div class="price-odr">

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_cover_100'); ?> : <br/>
							<span class="m-font-30"><?php echo $this->lang->line('label_cover_100_€_discount'); ?></span></p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_cover_50'); ?> : <br/>
							<span class="m-font-30"><?php echo $this->lang->line('label_cover_50_€_discount'); ?></span></p>
						...
						<div class="btn-condition">
						 <?php 	if(!empty($_SESSION['site_lang'])){
								...
								<a target="_blank" href="<?php echo base_url();?>assets/legal/3734_MODALITES_COVERER_PLUS_2024.pdf" class="btn  btn-block" style="color:#F5B5CA;background-color:#fff;border-color: #fff;"><?php echo $this->lang->line('label_reglementlink_data');?></a>

								<?php	} else {  ?>
								<a target="_blank" href="<?php echo base_url(); ?>assets/legal/3734_MODALITES_COVERER_PLUS_2024.pdf" class="btn btn-primary btn-block"><?php echo $this->lang->line('check_btn'); ?></a>
					...
					<div class="offer-form-inner mobilebgcoloproofdiv clearfix">
						...
						<div class="form-title">
							...
							<h2><?php echo $this->lang->line('label_to_get_your_coupon'); ?> :</h2>

						</div>

						<div class="form-main">

							<form class="form-in" role="form" method="post" action="<?php echo base_url('front/create_proof_of_cover_purchase_new'); ?>" enctype="multipart/form-data">
							 ...
							 <div class="radioms" style="color:#000;">
							    <input type="radio" id="clienttype"
  								 ...
  								 <label for="clienttype" class="radiobtt" style="margin-right:15px;"><span style="font-size:18px;font-weight:400;">Particulier</span></label>
  								   ...
  								   <input type="radio" id="clienttype"
 								    name="contact" value="pro" <?php if($clienttype == 'pro'){ echo 'checked'; } ?> style="transform:scale(1.5);margin-top: 7px;margin-right: 10px;">
							...
							<div class="form-group">
							   <label for="inputGroupFile01"><?php echo $this->lang->line('label_download'); ?> <span>
									<?php echo $this->lang->line('label_your_proof_of_cover_purchase'); ?></span></label>
							...
							<div class="form-group field-second">
								...
								<label for="selectrobot"><?php echo $this->lang->line('label_select'); ?> <span>
									<?php echo $this->lang->line('label_the_model_of_the_cover'); ?></span></label>
								
									<?php foreach ($getcovers as $getcover){ ?>
										<input type="radio" id="cover_<?php echo $getcover['id']; ?>" name="cover_id" value="<?php echo $getcover['id']; ?>" <?php if($getcover['id'] == $cover_id){ echo 'checked';} ?> style="transform:scale(1.5);margin-top: 7px;margin-right: 10px;">
										<label for="cover_<?php echo $getcover['id']; ?>" class="radiobtt" style="margin-right:15px;"><span style="font-size:18px;font-weight:400;"><?php echo $getcover['cover_name']; ?></span></label>
									<?php  } ?>

								<!-- <select class="custom-select" id="selectrobot" name="cover_id" required >
									<option selected value="none"><?php echo $this->lang->line('label_to_choose'); ?></option>
									<?php foreach ($getcovers as $getcover){ ?>
										<option value="<?php echo $getcover['id']; ?>" <?php if($getcover['id'] == $cover_id){ echo 'selected';} ?>><?php echo $getcover['cover_name']; ?></option>
									<?php  } ?>
								</select> -->
					            <div class="error"><?php echo form_error('cover_id'); ?></div>
							...
							<div class="form-group datesectiondiv">
							        <label for="inputGroupFile01"><?php echo $this->lang->line('datecover_label'); ?> </label>
							...
							<div class="form-group field-third another-handle">
								...
								<input type="hidden" value="FR" id="selectcovercountry" name="store_country" >
								<input type="hidden" value="FR" id="coversotrycountry" >
								...
								<label for="selectcovercountry"> <span><?php echo $this->lang->line('label_the_cover_magasin'); ?></span></label>
								<select name="store_id" class="custom-select store_id" id="selectpurchase">

										<option value="none"  <?php if('AUTRE' != $store_id){ echo 'selected';} ?> ><?php echo $this->lang->line('product_shop'); ?></option>
							...
							<div class="form-group field-ibanno bankdetails">
								...
								<button type="button" class="btn btn-primary triggerDrawcheckproof"><?php echo $this->lang->line('label_to_confirm'); ?></button>
				    ...
				    <div class="bottom-image text-center hidemobile" id="silderroboto">
						   <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
							  <div class="carousel-inner">
									...
									<img class="d-block " src="<?php echo base_url(); ?>/assets/image/cover1.jpg" alt="cover">
									</div>
									<div class="carousel-item">
									<img class="d-block " src="<?php echo base_url(); ?>/assets/image/cover2.jpg" alt="cover">
									</div>
									<div class="carousel-item">
									<img class="d-block " src="<?php echo base_url(); ?>/assets/image/cover3.jpg" alt="cover">
									</div>
									<div class="carousel-item">
									<img class="d-block " src="<?php echo base_url(); ?>/assets/image/cover4.jpg" alt="cover">
									</div>
							    </div>
