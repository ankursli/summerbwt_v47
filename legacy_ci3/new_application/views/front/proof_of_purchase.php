				...
				<div class="col-sm-12 col-md-6 offer-left-section">
					...
					<div class="offer-content-inner clearfix">
						...
						<div class="date-box">
							...
							<p><?php echo $this->lang->line('label_from_april_july_inline'); ?> </p>
						...
						<div class="price-odr">
							...
							<span class="m-font-30"><?php echo $this->lang->line('label_150_€_discount'); ?></span></p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p500'); ?> : 
							<span class="m-font-30"><?php echo $this->lang->line('label_100_€_discount'); ?></span></p>

							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_p400'); ?> : 
							<span class="m-font-30"><?php echo $this->lang->line('label_50_€_discount'); ?></span></p>
							
							<p><?php echo $this->lang->line('label_for_the_purchase_of_the_ref_250_cosmy'); ?> : 
							<span class="m-font-30"><?php echo $this->lang->line('label_60_€_discount'); ?></span></p>
							...
							<span class="m-font-30"><?php echo $this->lang->line('label_40_€_discount'); ?></span></p>
						...
						<div class="form-main">
							...
							<div class="form-group field-third another-handle">
								...
								<select name="store_id" class="custom-select store_id" id="selectpurchase">
										...
										<option value="none"  <?php if('AUTRE' != $store_id){ echo 'selected';} ?> ><?php echo $store_code; ?></option>
				    ...
				    <div class="bottom-image text-center hidemobile" id="silderroboto">
						   <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
							  <div class="carousel-inner">
									...
									<img class="d-block " src="<?php echo base_url(); ?>/assets/image/COSMY.png" alt="COSMY">
									</div>
