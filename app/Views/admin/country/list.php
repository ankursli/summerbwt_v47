<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo lang('Label.label_view_country');?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('admin/dashboard');?>"><i class="fa fa-dashboard"></i><?php echo lang('Label.label_home');?></a></li>
        <li><a href="<?php echo base_url('admin/country');?>"><?php echo lang('Label.label_country');?></a></li>
        <li class="active"><?php echo lang('Label.label_view_country');?></li>
      </ol>
    </section>
              ...
              <table id="viewuser" class="table table-bordered table-striped">
                <thead>
					<tr>
						...
						<th><?php echo lang('Label.label_country_code');?></th>
						<th><?php echo lang('Label.label_country_name');?></th>
						<!--th>Allow</th-->
					</tr>
                </thead>
                <tbody>
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url('admin/country/update');?>">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary"><?php echo lang('Label.label_allow_restriction');?></button>
				</div>
            </form>
          </div>
          <!-- /.box -->
