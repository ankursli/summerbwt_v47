            ...
            <form role="form" method="post" action="<?php echo base_url('admin/store/update/'.$stores[0]['id']);?>" enctype="multipart/form-data">
				...
				<div class="box-body">
					...
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" name="store_code" placeholder="<?php echo lang('Label.label_enter_store_code');?>" value="<?php echo $stores[0]['store_code'];?>">
						...
						<label for="exampleInputFName"><?php echo lang('Label.label_store_country');?></label>
							<select class="form-control" id="store_country" name="store_country" required>
								<option selected=""><?php echo lang('Label.label_choose_country');?></option>
									...
									?>
										<option value="<?php echo $getcountry['country_code'];?>"  <?php if($stores[0]['store_country'] == $getcountry['country_code']){echo 'selected';}; ?>><?php echo $getcountry['country_name'];?></option>
					...
					<div class="form-group">
					  ...
					  <input type="checkbox" name="store_handle" value="1" <?php echo ($stores[0]['store_handle']==1) ? 'checked':'';?>>
