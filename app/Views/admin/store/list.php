  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <?php echo lang('Label.label_view_store');?>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo lang('Label.label_view_store');?></li>
          ...
          <div class="box">
            ...
            <div class="box-header">
				...
				<div class="showuserfile" style="display:none">
					...
					<?php echo form_open_multipart('admin/store/UploadImportFile');?>
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo base_url('admin/store/edit/'.$store['id']);?>" class="btn btn-primary"><?php echo lang('Label.label_edit');?></a>  

							<a href="<?php echo base_url('admin/store/remove/'.$store['id']);?>" class="btn btn-danger"><?php echo lang('Label.label_remove');?></a>
