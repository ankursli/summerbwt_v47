<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content-header">
      <h1>
        <?php echo lang('Label.label_add_store_coupon_details');?>
      </h1>
	  <ol class="breadcrumb">
		...
		<li class="active"><?php echo lang('Label.label_add_store_coupon_details');?></li>
      </ol>
    </section>
		...
		<div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo lang('Label.label_create_store_coupon_details');?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo base_url('admin/storecoupon/create');?>" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="form-group">
					  <label for="exampleInputFName"><?php echo lang('Label.label_robot');?> <span class="error"> *</span></label>
					...
					<div class="form-group">
					  <label for="exampleInputEmail1"><?php echo lang('Label.label_used_limit');?></label>
