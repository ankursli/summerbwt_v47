<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <?php echo lang('Label.label_add_template');?>
	  ...
	  <ol class="breadcrumb">
		...
		<li class="active"><?php echo lang('Label.label_add_template');?></li>
		...
		<div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><?php echo lang('Label.label_create_template');?></h3>
				...
				<div class="box-body">
					...
					<div class="form-group">
					  ...
					  <select name="template_language" class="form-control">
						  ...
						  <option <?php if(!empty($templates) && $templates[0]['language'] == "FR"){echo "selected"; }?> value="FR">Français</option>

						  <option <?php if(!empty($templates) && $templates[0]['language'] == "EN"){echo "selected"; }?> value="EN">English</option>

						  <option <?php if(!empty($templates) && $templates[0]['language'] == "NL"){echo "selected"; }?> value="NL">Netherland</option>
					...
					<div class="form-group">
					  ...
					  <select name="template_type" class="form-control">
						  ...
						  <option <?php if(!empty($templates) && $templates[0]['type'] == "welcome"){echo "selected"; }?> value="welcome">Welcome</option>

						  <option <?php if(!empty($templates) && $templates[0]['type'] == "forgotpassword"){echo "selected"; }?> value="forgotpassword">Forgot Password</option>

						  <option <?php if(!empty($templates) && $templates[0]['type'] == "offerrobot"){echo "selected"; }?> value="offerrobot">Offer Robot</option>

						  <option <?php if(!empty($templates) && $templates[0]['type'] == "watertreatment"){echo "selected"; }?> value="watertreatment">Water Treatment</option>

						  <option <?php if(!empty($templates) && $templates[0]['type'] == "contract"){echo "selected"; }?> value="contract">Contract</option>
