<footer class="main-footer">
	<div class="pull-right hidden-xs">
	  <b><?php echo lang('Label.label_version');?></b> 2.4.0
	</div>
	<strong><?php echo lang('Label.label_copyright');?> &copy; 2019 <a href="https://adminlte.io">BWT</a>.</strong> <?php echo lang('Label.label_all_rights_reserved');?>.
</footer>
<style>
.error{
	color:red;
...
<script>
$(function () {
	// CKEDITOR.replace('editor1'); // Commented out to avoid errors if editor1 doesn't exist
});
//Date picker
$('#date').datepicker({
	format:'yyyy-mm-dd',
