<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content-header">
      <h1>
        <?php echo lang('Label.label_edit_proof');?>
      </h1>
	  <ol class="breadcrumb">
		...
		<li class="active"><?php echo lang('Label.label_edit_proof');?></li>
      </ol>
    </section>
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url('admin/proof/finalupdate?purchase='.$proofs[0]['purchase_id']);?>" enctype="multipart/form-data">
				<div class="box-body">
					...
					<a class="btn btn-danger" data-toggle="modal" data-target="#rejectmodal-<?php echo $proofs[0]['purchase_id'];?>"><?php echo lang('Label.label_rejected');?></a>
					<?php } ?>
					<?php /*if($proofs[0]['status']==1){?>
					<input type="submit" value="<?php echo lang('Label.label_rejected');?>" name="<?php echo lang('Label.label_rejected');?>" class="btn btn-danger">
					<?php } ?>
					<?php if($proofs[0]['status']==2){?>
					<input type="submit" value="<?php echo lang('Label.label_approved');?>" name="<?php echo lang('Label.label_approved');?>" class="btn btn-primary">
					<?php } */?>
				</div>
			</form>
					...
					<?php /*
					<a href="<?php echo base_url('admin/proof/newupdate?purchase='.$proofs[0]['purchase_id'].'&status=1');?>" class="btn btn-primary"><?php echo lang('Label.label_approved');?></a>
					<?php if($proofs[0]['status']==0){?>
					<a href="<?php echo base_url('admin/proof/newupdate?purchase='.$proofs[0]['purchase_id'].'&status=1');?>" class="btn btn-primary"><?php echo lang('Label.label_approved');?></a>
					<a href="<?php echo base_url('admin/proof/newupdate?purchase='.$proofs[0]['purchase_id'].'&status=2');?>" class="btn btn-danger"><?php echo lang('Label.label_rejected');?></a>
					<?php }?>
					<?php if($proofs[0]['status']==1){ ?>
					<a href="<?php echo base_url('admin/proof/newupdate?purchase='.$proofs[0]['purchase_id'].'&status=2');?>" class="btn btn-danger"><?php echo lang('Label.label_rejected');?></a>
					<?php } ?>
						...
						<tbody>
							...
							<tr style="background-color:<?php echo $color;?>">
								...
								<td> 
									...
									<a href="<?php echo base_url('admin/proof/update?purchase='.$proofs[0]['purchase_id'].'&status=1&coupon='.$couponcode['coupon_code']);?>" class="btn btn-primary"><?php echo lang('Label.label_approved');?></a>
